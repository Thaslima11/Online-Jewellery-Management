...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="middle" height="550"><table width="90%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" class="studdetailshead">Order Information By Credit </td>
        <td align="right" class="studdetailshead"><a href="login.jsp">login</a> | <a href="viewOrder.jsp">OrderByCash<a></td>
      </tr>
  ...
  <tr>
    ...
    <table  id="tab1"  width="738" border="1" bgcolor="#ffffff" cellspacing="1" cellpadding="0">
          <tr class="buttonm" bgcolor="#000000">
              ...
              <td width="169"><div align="center" style="color:#ffffff;"><b>Order_Date</b></div></td>
                <td width="169"><div align="center" style="color:#ffffff;"><b>CreditCard</b></div></td>
              <td width="169"><div align="center" style="color:#ffffff;"><b>Bank</b></div></td>
   ...
   <% 
    ...
    //Jewellery.ProductBean pb= new Jewellery.ProductBean();
     java.util.ArrayList arr1 =   db.getOrderDetils_credit();
    ...
    <td><%=pb.getCredit()%></td>
    <td><%=pb.getBank()%></td>
   <td><% if(pb.getStatus().equals("purchased")||pb.getStatus().equals("waiting")) { %><a href='*.Ordermgt?ordC=<%=pb.getOrder_id()%>'><%=pb.getStatus()%></a><% } else { %><%=pb.getStatus()%><% }%></td>
  </tr>
<% }%>
  ...
  <% if(request.getAttribute("ORDERMGTC") != null)

{ 
   Jewellery.ProductBean pb =( Jewellery.ProductBean) request.getAttribute("ORDERMGTC");
  
   %>
 
 <form name="form1" method="post" action="*.Ordermgt" >
 <input name="ordC1" type="hidden" value="<%=pb.getOrder_id()%>">
